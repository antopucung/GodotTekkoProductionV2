...
function OnboardingContent({ children }: OnboardingManagerProps) {
...
function OnboardingLoading({ children }: OnboardingManagerProps) {
  return (
    <>
      {children}
      {/* Show a minimal loading state while search params are being read */}
    </>
  )
}
...
export function OnboardingManager({ children }: OnboardingManagerProps) {
  return (
    <Suspense fallback={<OnboardingLoading>{children}</OnboardingLoading>}>
